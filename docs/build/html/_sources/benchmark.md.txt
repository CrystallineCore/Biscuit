...
| **vs. Biscuit Speedup** | 1.0× | 0.29× (3.5× slower) | 0.20× (5.0× slower) |
...
| B-tree | 63.81 | 48.67 | 8.2× slower |
| Trigram | 58.41 | 45.23 | 7.5× slower |
...
| B-tree | 237.06 | 189.34 | 5.3× slower |
| Trigram | 133.32 | 97.45 | 3.0× slower |
...
| B-tree | 152.03 | 124.56 | 5.1× slower |
| Trigram | 93.28 | 74.32 | 3.1× slower |
...
**Winner**: **Biscuit** - 3-80× faster depending on pattern
...
**For wildcard pattern matching workloads, Biscuit offers substantial performance advantages that justify its larger storage footprint.**
